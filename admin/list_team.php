<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
	...
	$result=mysqli_query($conn,"select * from tbl_team  order by u_id DESC");
    ...
    <div class="panel-body">
		...
		<?php
			...
			while($row=mysqli_fetch_array($result))			{
				...
				<td class="text-center" width="300"> <?php echo  $row['type'];?></td>
				
				
			<td class="text-center" width="300"><a href="edit_team.php?u_id=<?php echo $row['u_id'];?>">Edit|<a href="delete_team.php?u_id=<?php echo $row['u_id'];?>"onclick="return confirm('are you sure want to delete')">Delete</td>
