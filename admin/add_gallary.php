  ...
  <script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
     <script src="js/demo_gallery.js"></script>
...
$upload_dir = 'images/';
 ...
 $q="insert into `gallery`(image,status)values('$userpic',1)";
  $query=mysqli_query($conn,"insert into `gallery`(image,status)values('$userpic',1)");
		print_r($query);
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">      
                        <h3 class="panel-title"><b>add gallery:</b> </h3>  
