...
$result = mysqli_query($conn, "SELECT * FROM `tbl_product` where status=1 order by pro_id desc");
        ...
        <table id="customers2" class="table datatable">
            <thead>
                <tr>
					...
					<th class="textt-center">Price</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="300"><img src="images/thumb/<?php echo $row['image']; ?>" height="100" width="100" /></td>
						 <td class="text-center"  width="300" ><?php multiple_image($pro_id); ?></td>
						<td class="text-center" width="300"><?php echo $row['descrip']; ?></td>
						<td class="text-center" width="300"><?php echo $row['price']; ?></td>
						<td class="text-center" width="300"><a href="edit_products.php?id=<?php echo $row['pro_id']; ?>">Edit</a><label> | </label><a href="delete_product.php?status=<?php echo $row['pro_id']; ?>&&id=<?php echo $row['pro_id'];?>" onclick="return confirm('are you sure want to delete')">Delete</a><label> | </label><a href="add_multiple_image?pro_id=<?php echo $row['pro_id']; ?>">ADD Multiple images</a></td>		
...
function multiple_image($pro_id)
{
	...
	echo '<img src="images/thumb/'.$res['image'].'" height="80" width="80" style="margin-right:5px;" />';
}
}
