<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
	...
	$result=mysqli_query($conn,"select * from tbl_sample where id='$update'");
    ...
    if (isset($_POST['save'])) {
		...
		$qry=mysqli_query($conn,"update tbl_sample set `name`='$name',`description`='$description',`image`='$userpic' where `id`='$demo'");
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
						...
						<input type="hidden" class="form-control" id="" value="<?php echo $row['id']; ?>" name="reupdate">
