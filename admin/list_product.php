...
$result = mysqli_query($conn, "SELECT * FROM `tbl_service`  where status=1 order by pro_id desc");
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
						...
						<td class="text-center"><a href="edit_product.php?pro_id=<?php echo $row['id']; ?>">Edit</a><label> | </label><a href="delete_product.php?status=<?php echo $row['id'];?>" onclick="return confirm('are you sure want to delete')">Delete</a></td>		
