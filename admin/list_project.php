<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
	...
	$result=mysqli_query($conn,"select * from tbl_product  order by pro_id DESC");
...
<td class="text-center" width="300"> <?php echo substr($row['descrip'],20);?></td>

				
				
			<td class="text-center" width="300"><a href="edit_project.php?pro_id=<?php echo $row['pro_id'];?>">Edit|<a href="delete_project.php?pro_id=<?php echo $row['pro_id'];?>"onclick="return confirm('are you sure want to delete')">Delete</td>
