<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
	...
	$result=mysqli_query($conn,"select * from tbl_team where u_id='$update'");
    ...
    if (isset($_POST['save'])) {
		...
		$qry=mysqli_query($conn,"update tbl_team set `name`='$name',`type`='$type',`description`='$description',`image`='$userpic' where `u_id`='$demo'");
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">      
                        <h3 class="panel-title"><b> Add team</b> </h3>  
                ...
                <div class="box">
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
						...
						<input type="hidden" class="form-control" id="" value="<?php echo $row['u_id']; ?>" name="reupdate">
							...
							<tr>
                                <th width="30%"> <span class="error">*</span> Type :</th>

                                <td><input type="text" name="type" id="type" class="form-control" value="<?php echo $row['type'];?>"  maxlength="100"/></td>
                            </tr>
