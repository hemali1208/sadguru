  ...
  <script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
     <script src="js/demo_team.js"></script>
...
$upload_dir = 'images/';
    ...
    if (in_array($imgExt, $valid_extensions)) {
		...
		echo $q="insert into `tbl_team`(name,type,description,image)values('$name','$type','$description','$userpic')";
		//die;
	   $query=mysqli_query($conn,"insert into `tbl_team`(name,type,description,image)values('$name','$type','$description','$userpic')");
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
                        ...
                        <table class="table">
							...
							<tr>
                                ...
                                <td><input type="text" name="type" id="type" class="form-control" placeholder="Enter Type" maxlength="100"/></td>
                            </tr>
