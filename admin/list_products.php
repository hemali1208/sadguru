            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
						...
						<td class="text-center" width="300"><a href="edit_products?id=<?php echo $row['pro_id']; ?>">Edit</a><label> | </label><a href="delete_product.php?status=<?php echo $row['pro_id']; ?>" onclick="return confirm('are you sure want to delete')">Delete</a></td>		
