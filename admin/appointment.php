...
$result = mysqli_query($conn,"SELECT * from get_appointment");
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
						...
						<td class="text-center" width="300"><?php echo $row['subject']; ?></td>
						<td class="text-center" width="300"><?php echo $row['message']; ?></td>
