                 ...
                 <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                    ...
                    <!-- End Right sidebar -->
					 ...
					 <div class="row mar-row">
                          		...
                          		<?php
								$id=$_GET['id']; 
								$result1 = mysqli_query($conn, "SELECT * FROM `tbl_sample` where id='$id' order by id desc LIMIT 4");
						...
						?>
                                ...
                                <div class="single-page">
								 <div class="page-img elec-page">
                                        <img src="admin/images/<?php echo $row1['image']; ?>"  alt="">
                                    </div>
									</div>
									    </div> 
    ...
    <div class="modal-content">
      <div class="modal-header text-center">
	   ...
	   <form role="form" method="post" name="" id="list_inquiry"> 
		...
		<!--<input type="hidden" class="form-control" id="c_name" value="<?php echo $page; ?>" name="c_id">-->
